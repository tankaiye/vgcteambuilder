...
with open("internal_data/pokemonstats.txt") as pokemonlist:
...
with open("internal_data/pokemonmoves.txt") as movelist:
...
with open("internal_data/pokemonweights.txt") as weightlist:
...
with open("internal_data/manyothersmoves.txt") as movelist:
    for move in movelist:
        if len(move) > 6:
            movesep = move.replace("\n","")
...
with open("internal_data/plateitems.txt") as platelist:
...
with open("internal_data/soundmoves.txt") as soundlist:
...
with open("internal_data/slicemoves.txt") as slicelist:
...
with open("internal_data/bulletmoves.txt") as bulletlist:
...
with open("data/rawresultsd" + str(dsum1weight) + "d" + str(dsum2weight) + "x1.txt", "a") as file:
    for i in range(0, 42):
        filetoread = "data/teamstotest/10/testfile" + str(i) + ".txt"
        evalresults = getoverallworstteammatchups(formatfromshowdown(filetoread))
        file.write(str(evalresults[1]))
        with open("data/resultsd" + str(dsum1weight) + "d" + str(dsum2weight) + "x1.txt", "a") as otherfile:
