...
def cross_eval_simple(
    ...
    agent = SimpleHeuristicsPlayer(
        ...
        open_timeout=None,
        team=TestTeamBuilder(1, num_teams_1, battle_format, 1, 1),
    )
    opponent = SimpleHeuristicsPlayer(
        ...
        accept_open_team_sheet=True,
        open_timeout=None,
        team=TestTeamBuilder(1, num_teams_2, battle_format, 2, 56),
    )
    awin = []
    owin = []
    total_battles = 0
...
if __name__ == "__main__":
    ...
    parser.add_argument("--num_teams_1", type=int, default=56, help="Number of teams to eval with")
    parser.add_argument("--num_teams_2", type=int, default=234, help="Number of teams to eval with")
    ...
    cross_eval_simple(battle_format, args.num_teams_1, args.num_teams_2, args.port, args.device, 13104, 100)
