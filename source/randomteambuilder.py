...
while testpoke <= 56:
    ...
    for i in range(5):
        totest = random.randint(0, 56)
        while totest in bestteam or totest == 46:
            totest = random.randint(0, 56)
        bestteam.append(totest)
    ...
    for i in range(len(bestteam)):
        ...
        for j in range(0,len(spreads)):
            localmon = spreads[random.randint(0, len(spreads) - 1)][0]
        ...
        print(bestmon)
        print(bestavmon)
        if bestmon == None and bestavmon == None:
            break
        if bestavmon == None:
            allmovespreads = getallmovespreads(pokemoves)
        else:
            allmovespreads = getallmovespreads(pokemoves, False)
        localmoves = allmovespreads[random.randint(0, len(allmovespreads) - 1)]
        #print("Testing:")
        #print(localmoves)
